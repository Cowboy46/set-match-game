...
function Menu()
    ...
    BackGround = CreateSprite( LoadImage( "Screens/Background6.png" ) )
	
	//load buton images
    LoadImage( 1, "Buttons/SignIn.png" )
    LoadImage( 3, "Buttons/SignUp.png" )
    LoadImage( 4, "Buttons/SignOut.png" )
    LoadImage( 5, "Buttons/Settings.png" )
    LoadImage( 6, "Buttons/HelpButton.png" )
    LoadImage( 7, "Buttons/Play3.png" )
    LoadImage( 8, "Buttons/Play1.png" )
    LoadImage( 9, "Buttons/Play2.png" )
    LoadImage( 20, "Buttons/Play32.png" )
    LoadImage( 21, "Buttons/Play12.png" )
    LoadImage( 22, "Buttons/ViewCurrent.png" )
    LoadImage( 23, "Buttons/ViewCurrent2.png" )
    LoadImage( 10, "Buttons/AccountButton.png" )
    
    LoadImage( 2, "MiscImages/DisplayPanel.png" )
    LoadImage( 11, "Labels/Company.png" )
    LoadImage( 14, "Labels/Logo3.png" )
    
    //load sounds
    LoadSound( 1, "Sounds/Swoosh.wav" )
    LoadSound( 3, "Sounds/Select.wav" )
    ...
    if GetMusicExists( 1 ) = 0
        LoadMusic( 1, "Sounds/Music/MenuSoundtrack.mp3" )
        PlayMusic( 1 )
    ...
    do
        ...
        if GetPointerPressed() = 1
            ...
            if GetSpriteHitTest( 5, GetPointerX(), GetPointerY() ) = 1 or GetTextHitTest( 5, GetPointerX(), GetPointerY() ) = 1
                PlaySound( 1 )
                LoadImage( 100, "Buttons/MusicOn.png" )
                LoadImage( 101, "Buttons/SoundOn.png" )
                LoadImage( 102, "Buttons/MusicOff.png" )
                LoadImage( 103, "Buttons/SoundOff.png" )
                LoadImage( 104, "Labels/SettingsLogo.png" )
                ...
                CreateSprite( 102, LoadImage( "Buttons/Home.png" ) )
                SetSpriteScale( 102, .4, .4 )
                SetSpritePosition( 102, 2, 439)
            ...
            if GetSpriteHitTest( 12, GetPointerX(), GetPointerY() ) = 1 and GetSpriteColorAlpha( 12 ) = 255
                LoadImage( 100, "Labels/MyGames.png" )
                LoadImage( 101, "Buttons/Home.png" )
                LoadImage( 102, "MiscImages/GameBanner.png" )
                ...
                if number$="0"
                    ...
                    for i = 1 to number
                        ...
                        spriteId = spriteId + 1
                        CreateSprite( spriteId, LoadImage( "Labels/Turn" + turn$ + ".png" ) )
...
function NewGameScreen()
    Background = CreateSprite( LoadImage( "Screens/Background5.png" ) )
    LoadImage( 1, "Labels/YourTurn.png" )
    LoadImage( 2, "Labels/Round1Black.png" )
    LoadImage( 3, "Buttons/Start.png" )
    LoadImage( 4, "Buttons/Home.png" )
...
function Login()
	...
	//load label images
	LoadImage( 2, "Labels/LoginTitle.png" )
	LoadImage( 5, "Labels/Question.png" )
	
	//load button images
	LoadImage( 3, "Buttons/Login.png" )
	LoadImage( 4, "Buttons/SignUp.png" )
	LoadImage( 6, "Buttons/EmptyCheckBox.png" )
	LoadImage( 7, "Buttons/FilledCheckBox.png" )
	LoadImage( 8, "Buttons/Home.png" )
...
function SignUp()
	...
	//load label images
	LoadImage( 1, "Labels/Info.png" )
	LoadImage( 2, "Labels/SignUpText.png" )
...
function Game( gameNumber )
	...
	//load card shape images
	LoadImage( 1, "CardShapes/WSquareSolid.png" )
	LoadImage( 2, "CardShapes/WSquareShaded.png" )
	LoadImage( 3, "CardShapes/WSquareOutline.png" )
	LoadImage( 4, "CardShapes/WStarSolid.png" )
	LoadImage( 5, "CardShapes/WStarShaded.png" )
	LoadImage( 6, "CardShapes/WStarOutline.png" )
	LoadImage( 7, "CardShapes/WElipseSolid.png" )
	LoadImage( 8, "CardShapes/WElipseShaded.png" )
	LoadImage( 9, "CardShapes/WElipseOutline.png")
	LoadImage( 10, "CardShapes/EmptyCard.png" )
	LoadImage( 12, "CardShapes/ClickedCard.png" )
	LoadImage( 19, "CardShapes/WrongCard.png" )
	
	//load button images
	LoadImage( 18, "Buttons/PauseButton.png" )
	LoadImage( 25, "Buttons/PlayButton.png" )
	LoadImage( 26, "Buttons/QuitGame2.png" )
	LoadImage( 17, "Buttons/SwapButton.png" )
	LoadImage( 22, "Buttons/PlayAgain.png" )
	LoadImage( 23, "Buttons/Home.png" )
	
	LoadImage( 13, "Screens/CardTable.png" )
	LoadImage( 14, "MiscImages/Clock.png" )
	LoadImage( 16, "Labels/Logo.png" )
	LoadImage( 20, "Screens/EndGame.png" )
	LoadImage( 21, "Labels/YourScore.png" )
	LoadImage( 24, "Screens/PauseScreen.png" )
	
	//load sounds
	LoadSound( 1, "Sounds/RegularClock.wav" )
	LoadSound( 3, "Sounds/Buzzer.wav" )
	LoadSound( 4, "Sounds/Wrong.wav" )
	LoadSound( 5, "Sounds/Select.wav" )
	LoadSound( 6, "Sounds/Ding.wav" )
	LoadSound( 7, "Sounds/Coin.wav" )
	LoadSound( 8, "Sounds/ChaChing.wav" )
	LoadSound( 9, "Sounds/DingLing.wav" )
	LoadSound( 10, "Sounds/FranticTimer.wav" )
	LoadSound( 11, "Sounds/Pause.wav" )
	LoadSound( 12, "Sounds/Card.wav" )
	LoadSound( 13, "Sounds/Swoosh.wav" )
...
function Clock()
    time = time + 1
    if Mod(time, 60) = 0 and time <= 10800
        if seconds = 0
            minutes = minutes - 1
            seconds = 59
        else
    ...
    if seconds = 10 and minutes = 0 and Mod(time, 60) = 0
        PlaySound( 1, 50, 1 )
    endif
...
function MakeCard( id, xCoordinate, yCoordinate )
    ...
    while someCounter < 12
        ...
        if GetSpriteExists( someCounter )=1
            if someCounter <> id
                if CardProperties# [ 1, someCounter ] = number and CardProperties# [ 2, someCounter ] = color and CardProperties# [ 3, someCounter ] = Mod(kind, 3) and CardProperties# [ 4, someCounter ] = ceil( shape# )
                    color = random (1, 3)
                    number = random (1, 3)
                    kind = random (1, 9)
                    initialId = symbolId
    ...
    CardProperties# [ 3, id ] = Mod(kind, 3)
...
function EndGame()
    ...
    do
        ...
        if time > 60 and Mod(time, 4) = 0 and currentScore < score
            PlaySound( 6 )
        endif
        ...
        if currentScore = score and GetSpriteExists( 302 )=0
            ...
            if GetMusicExists( 1 ) = 1 and GetMusicExists( 2 ) = 0
                LoadMusic( 2, "Sounds/Music/SecondSoundtrack.mp3" )
                PlayMusic( 2 )
    ...
    do
        ...
        if GetPointerPressed()=1 and GetSpriteHitTest( 251, GetPointerX(), GetPointerY() )=1
            if GameNumber = 0
                ...
                PlaySound( LoadSound( "Sounds/Warning.wav" ) )
                CreateSprite( 252, LoadImage( "Screens/BlackScreen.png" ) )
                SetSpriteColorAlpha( 252, 150 )
                CreateSprite (253, LoadImage( "Labels/Warning.png" ) )
                SetSpriteScale( 253, 1.2, 1.2)
                SetSpritePosition( 253, 10, 160 )
                CreateSprite( 254, LoadImage( "Buttons/Okay.png" ) )
                SetSpritePosition( 254, 60, 220 )
                CreateSprite( 255, LoadImage( "Buttons/Return.png" ) )
